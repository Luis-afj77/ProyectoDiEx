...
boxplots.df <- data.frame(sujetos_progabide$y, sujetos_progabide$period)
colnames(boxplots.df)

names(boxplots.df)[names(boxplots.df) == "sujetos_progabide.y"] <- "crisis"
names(boxplots.df)[names(boxplots.df) == "sujetos_progabide.period"] <- "periodo"
boxplots.df$periodo <- as.factor(boxplots.df$periodo)

#añadiendo la base/4 como periodo 0

period0 <- data.frame(crisis= sujetos_progabide$base / 4, periodo = 0)
