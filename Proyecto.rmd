...
```
# De las crisis en grupos placebo
```{r}
...
```
# placebo línea base ERROR NAS
```{r}
placebo_periodo0 <- sujetos_placebo %>% filter(base=="")
...
write.csv(placebobase_descriptiva,"C:/Users/luisf/EstaDescriptiva_placebobase.csv", row.names = FALSE)
```
...
write.csv(placeboperiodo1_descriptiva,"C:/Users/luisf/EstaDescriptiva_placeboperiodo1.csv", row.names = FALSE)
```
...
write.csv(placeboperiodo2_descriptiva,"C:/Users/luisf/EstaDescriptiva_placeboperiodo2.csv", row.names = FALSE)
```
...
write.csv(placeboperiodo3_descriptiva,"C:/Users/luisf/EstaDescriptiva_placeboperiodo3.csv", row.names = FALSE)
```
...
write.csv(placeboperiodo4_descriptiva,"C:/Users/luisf/EstaDescriptiva_placeboperiodo4.csv", row.names = FALSE)
```

# De las crisis en grupos progabide
```{r}
...
```
# progabide línea base ERROR NAS
```{r}
progabide_periodo0 <- sujetos_progabide %>% filter(period=="0")
media <- mean(progabide_periodo0$y)
media
mediana <- median(progabide_periodo0$y)
mediana
moda <- mfv(progabide_periodo0$y)
moda
sd <- sd(progabide_periodo0$y)
sd
var <- var(progabide_periodo0$y)
var
q <- quantile(progabide_periodo0$y)
q
iqr <- IQR(progabide_periodo0$y)
iqr
cv <- sd/media
cv
ran <- range(progabide_periodo0$y)
ran
progabidebase_descriptiva <- c(media,mediana,moda,sd,var,q,iqr,cv,ran)
write.csv(progabidebase_descriptiva,"C:/Users/luisf/EstaDescriptiva_progabidebase.csv", row.names = FALSE)
```
...
write.csv(progabideperiodo1_descriptiva,"C:/Users/luisf/EstaDescriptiva_progabideperiodo1.csv", row.names = FALSE)
```
...
write.csv(progabideperiodo2_descriptiva,"C:/Users/luisf/EstaDescriptiva_progabideperiodo2.csv", row.names = FALSE)
```
...
write.csv(progabideperiodo3_descriptiva,"C:/Users/luisf/EstaDescriptiva_progabideperiodo3.csv", row.names = FALSE)
```
...
write.csv(progabideperiodo4_descriptiva,"C:/Users/luisf/EstaDescriptiva_progabideperiodo.csv", row.names = FALSE)
```
